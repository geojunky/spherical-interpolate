/* ssrfpack.f -- translated by f2c (version 20090411).
...
9.6,\002,  \002),f9.6/1x,19x,\002P2 = \002,2(f9.6,\002,  \002),f9.6)";
...
i5,\002 NODES\002//1x,18x,\002N1\002,5x,\002N2\002,8x,\002TENSION\002//)";
